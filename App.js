...
export default class LoginView extends Component {
  ...
  constructor(props) {
    ...
    Leanplum.track('React Native Project');
...
//Sets a custom device ID. If this is not called, Leanplum will assign a device ID automatically.	
  ...
  onUser_Login = () => {
    ...
    Leanplum.setUserAttributes({'email': this.state.email, 'gender': 'Male', 'age': 30, 'name': this.state.name, 'phone': this.state.phone_no,
